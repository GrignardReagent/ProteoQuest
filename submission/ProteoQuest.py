...
# the following script takes an input from the user, asking them the taxonomic group they'd like to search for,
# then it asks the user which protein they'd like to search for,
# then it asks whether they'd like to search for a partial match or not,
# finally it combines all the search terms the user has specified and save it as search_term .
...
print("Welcome to the ProteoQuest programme!"
      "\nThis programme is used for searching protein sequences within the NCBI protein database"
...
def get_search_term():
    ...
    if partial_protein == 'y':
        ...
        # get the user_input and protein_type as search_term if no input was given
